...
package models.auto_generated.slick
...
trait Default {
  ...
  class UserGroupTable(_tableTag: Tag) extends Table[UserGroup](_tableTag, "UserGroup") {
  ...
  implicit def GetResultUser(implicit e0: GR[String], e1: GR[org.threeten.bp.OffsetDateTime], e2: GR[Option[org.threeten.bp.OffsetDateTime]], e3: GR[Option[String]], e4: GR[Option[Int]]): GR[User] = GR{
    prs => import prs._
    val r = (<<?[Int], <<[String], <<[String], <<[org.threeten.bp.OffsetDateTime], <<?[org.threeten.bp.OffsetDateTime], <<?[org.threeten.bp.OffsetDateTime], <<?[String])
    import r._
  ...
  class UserTable(_tableTag: Tag) extends Table[User](_tableTag, "User") {
    ...
    val created: Rep[org.threeten.bp.OffsetDateTime] = column[org.threeten.bp.OffsetDateTime]("created")
    /** Database column lastLogin SqlType(timestamptz), Default(None) */
    val lastLogin: Rep[Option[org.threeten.bp.OffsetDateTime]] = column[Option[org.threeten.bp.OffsetDateTime]]("lastLogin", O.Default(None))
    /** Database column lastAction SqlType(timestamptz), Default(None) */
    val lastAction: Rep[Option[org.threeten.bp.OffsetDateTime]] = column[Option[org.threeten.bp.OffsetDateTime]]("lastAction", O.Default(None))
  ...
  class UserToUserGroupTable(_tableTag: Tag) extends Table[UserToUserGroup](_tableTag, "UserToUserGroup") {
